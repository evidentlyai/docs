...
Synthetic input generation allows you to create test questions from descriptions and examples. This helps expand test coverage and evaluate how your AI system handles different types of queries.

You can use this to:
* Generate test questions for RAG systems where you only need queries without predefined answers.
...
Define what kind of inputs you need by providing a brief description of the task or domain, and choose how many inputs to generate. For example, if you’re building a travel assistant, you could enter:
