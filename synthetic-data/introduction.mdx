...
<Check>
This feature is available in Evidently Cloud. Check details on the [pricing](https://www.evidentlyai.com/pricing) page. [Reach out](https://www.evidentlyai.com/get-demo) if you’d like a demo.
</Check>
...
<CardGroup cols={3}>
  ...
  <Card title="Adversarial tests" icon="shield-halved" href="/synthetic-data/adversarial_data">
    Generate inputs to test for vulnerabilities and edge cases.
  </Card>
</CardGroup>