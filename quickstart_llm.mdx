...
**Get a Dashboard**. As you run more evals, it's useful to track them over time. Go to "Dashboard" in the left menu, enter the "Edit" mode, and add a new "Columns" tab:
