...
* **Sentiment**
  ...
  : from -1 for negative to 1 for positive.
...
* **Denials**
  ...
  : detect if the chatbot denied an answer. This uses LLM-as-a-judge with a built-in prompt (defaults to 
...
* **Sentiment**
   ...
   is non-negative (greater or equal to 0)

* **Text length**

   is at most 150 symbols.
...
See how you can configure [LLM judges for custom criteria](/metrics/customize_llm_judge).