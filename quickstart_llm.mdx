...
<Info>
  **Alternative**. If you don't have an OpenAI key, you can run a deterministic eval that checks if words "sorry" or "apologize" are present (True/False). Use the `IncludesWords` as shown in the code comment.
</Info>
