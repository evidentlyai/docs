...
Now, let's create a Report to summarize all individual scores and test the results. Let's run a check:
...
<Tabs>
  <Tab title="Evidently Cloud">
    Send results to Evidently Cloud
    ...
    **Get a Dashboard**.  Go to the "Dashboard" tab and enter the "Edit" mode. Add a new tab, and select the "Descriptors" template.
