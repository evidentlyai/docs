...
Evidently helps you evaluate LLM outputs automatically. This lets you make objective choices and move faster as you iterate on prompts, test new models, run adversarial checks, or evaluate live data. 
...
<Info>
  **Preparing data**. You can provide data with any structure. Some common setups:
...
We'll use OpenAI for LLM-as-a-judge. Set your OpenAI key as an environment variable:
...
**Create a Report**. It will summarize the evaluation results. You can view it locally or in the Cloud.
