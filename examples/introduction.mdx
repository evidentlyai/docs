...
<CardGroup cols={2}>
  ...
  <Card title="Evidently + Grafana: LLM evals" icon="bar-chart" href="https://github.com/evidentlyai/evidently/tree/main/examples/llm_eval_grafana_dashboard">
    Visualize Evidently LLM evaluation metrics with Grafana. (Postgres as a database).
  </Card>
  <Card title="Evidently+ Grafana: Data drift" icon="bar-chart" href="https://github.com/evidentlyai/evidently/tree/main/examples/data_drift_grafana_dashboard">
    Visualize Evidently data drift evaluation results on a Grafana dashboard. (Postgres as a database).
  </Card>
</CardGroup>
