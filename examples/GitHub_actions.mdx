...
- You define a test dataset of inputs (e.g. test prompts with or without reference answers).
- Run your LLM system or agent against those inputs inside CI.
- Evidently automatically evaluates the outputs using the user-specified config, including methods like:
