...
**Test Suite**. To add pass/fail classification quality Tests, auto-generated from the reference dataset:
...
**Test Suite**. If you enable Tests, this will automatically run checks bto compare model performance metrics against reference.
