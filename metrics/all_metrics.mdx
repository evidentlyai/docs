...
| **DatasetStats**      | <ul><li>Small preset. </li><li> Dataset-level.</li><li>Calculates descriptive dataset stats, including mumber of columns by type, rows, missing values, empty columns, etc.</li><li>Metric result: all metrics included in preset.</li></ul> | None                                      | <ul><li>**No reference**: TBC.</li><li>**With reference**: Same as for Metrics in Preset.</li></ul>                                       |
