...
| **RowCount()**          | <ul><li> Dataset-level.</li><li>Counts the number of rows.</li><li>Metric result: TBC.</li></ul>                                                                                                                                                      | None                                      | <ul><li>**No reference**: Fails if the number of rows is  ≤ 30.</li><li>**With reference**: Fails if row count differs by >10%.</li></ul> |
