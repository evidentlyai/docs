...
| **DatasetStats**      | <ul><li>Small preset. </li><li> Dataset-level.</li><li>Calculates descriptive dataset statistics, including mumber of columns by type, mumber of rows, missing values, empty columns, constant and almost constant columns, duplicated and almost duplicated columns</li></ul> | None                                      | <ul><li>**No reference**: TBC.</li><li>**With reference**: Same as for Metrics in Preset.</li></ul>                                       |
