...
| **MinValue()**      | <ul><li>Column-level.</li><li>Returns min value for a given numerical column.</li><li>Metric result: `min`.</li></ul>                                                                                                                               | **Required**: <ul><li>`column`</li></ul> **Optional**: <ul><li> [Text conditions](/docs/library/tests)</li></ul> |<ul><li>**No reference**. N/A.</li><li>**With reference**. Tests that Min Value is within +/-10% from the reference.</li></ul>             |
| **StdValue()**      | .                                                                                                                                                                                                                     |                                          |                                                                                                                                            |
| **MeanValue()**     |                                                                                                                                                                                                                       |                                          |                                                                                                                                            |
| **MaxValue()**      |                                                                                                                                                                                                                       |                                          |                                                                                                                                            |
| **MedianValue()**   |                                                                                                                                                                                                                       |                                          |                                                                                                                                            |
