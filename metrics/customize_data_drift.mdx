...
**Drift methods**. You can also specify the drift detection methods: set one method for all columns, by type or individually.&#x20;

For example, to use PSI (Population Stability Index) for all columns in the dataset:
