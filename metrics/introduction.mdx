...
Evidently offers 100+ customizable evals with visualizations. That's a core library feature. 

Before exploring, make sure you ran a simple eval (for [LLMs](../quickstart_llm), for [ML](../quickstart_ml)) and know the key components:
