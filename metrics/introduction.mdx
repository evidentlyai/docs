...
Evaluations are a core feature of the Evidently library. It offers both an catalog of 100+ ready-made evaluations, and a framework to easily implement and configure yours.

Before exploring, make sure you're familiar with the eval workflow (check a Quickstart for [LLMs](../quickstart_llm), for [ML](../quickstart_ml)) and core concepts like `Descriptors`, `Metrics` and `Tests`.
