...
* Generative systems: summarization, Q&A system, chatbots, agents, RAGs, etc.
...
Before exploring, make sure you are familiar with the core evaluation workflow (try an example for [LLMs](../quickstart_llm) or [ML](../quickstart_ml)) and concepts like `Descriptors`, `Metrics` and `Tests`.
