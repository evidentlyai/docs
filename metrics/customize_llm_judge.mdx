...
| `target_category`     | Name of the target category you want to detect (e.g., you care about the precision/recall for this category more than the other). There is no impact to the prompt or evaluation, but this can be useful if you later run quality evaluations for your LLM judge by comparing it to the ground truth labels. | Custom category (required)                  |
...
| `include_reasoning`   | Specifies whether to include reasoning in the classification. It will be included with the result.                                                                                                                                                                                                           | `True` (Default), `False`                   |
...
| `model`               | Specifies the model used for evaluation.                                                                                                                                                                                                                                                                     | Any available OpenAI model (e.g., `gpt-3.5-turbo`, `gpt-4`) |
