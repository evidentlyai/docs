...
**You can set different thresholds**. You can specify a custom threshold as a [parameter](https://docs.evidentlyai.com/user-guide/customization/options-for-statistical-tests).

## Input data requirements

#### [](https://docs.evidentlyai.com/reference/data-drift-algorithm#empty-columns)&#xA;Empty columns
...
#### [](https://docs.evidentlyai.com/reference/data-drift-algorithm#empty-values)&#xA;Empty values
...
By default, drift tests do not react to changes or increases in the number of empty values. Since the high number of nulls can be an important indicator, we recommend grouping the data drift tests (that check for distribution shift) with data integrity tests (that check for a share of nulls). You can choose from several null-related [tests](https://docs.evidentlyai.com/reference/all-tests#data-integrity) and metrics and set a threshold.
...
## [](https://docs.evidentlyai.com/reference/data-drift-algorithm#resources)

## [](https://docs.evidentlyai.com/reference/data-drift-algorithm#input-data-requirements)