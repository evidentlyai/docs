...
* **Create a Project**. Click on the “plus” sign on the home page, type your Project name and description.
...
| `date_from: Optional[datetime.datetime] = None` | Start DateTime of the monitoring Dashboard. By default, Evidently shows data for all available periods based on the Report timestamps. | `datetime.now() + timedelta(-30)`                                                                                               |
