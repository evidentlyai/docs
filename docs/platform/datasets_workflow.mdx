...
You will be able to view all Datasets, both raw datasets uploaded directly to the platform or generated as a result of an evaluation.

<Tip>
  **Tracing**. Datasets created from Traces are in the Tracing menu section.
</Tip>
...
To get a Project ID, grab it from the existing Project page or create a new Project first. (How to [work with Projects](projects_overview))
...
You can also include Datasets when you upload Reports to the platform. This way, after running an evaluation locally you simultaneously upload the evaluation result and the Dataset it was generated for, with added scores if applicable.
...
This is optional. Check the docs on [generating snapshots](../library/snapshots) for details.