...
For example, if you log multiple Data Drift Reports (where each includes the`DriftedColumnsCount` for the corresponding batch), you can plot how this Metric value changes over time.
