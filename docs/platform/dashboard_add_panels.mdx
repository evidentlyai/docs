...
<Note>
  **Check Metric results.** You can verify the output name in the [All Metrics table](/metrics/all_metrics). You can also see it if you generate a Report with a given Metric and export the results as a Python dictionary or JSON.
</Note>
