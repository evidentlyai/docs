...
| Parameter     | Environment variable name               | Description                     | Default                         |
| ------------- | --------------------------------------- | ------------------------------- | ------------------------------- |
| `address`     | `EVIDENTLY_TRACE_COLLECTOR`             | Trace collector address (`str`) | `https://app.evidently.cloud/`. |
| `api_key`     | `EVIDENTLY_TRACE_COLLECTOR_API_KEY`     | Evidently Cloud API Key.        | `None`                          |
| `export_name` | `EVIDENTLY_TRACE_COLLECTOR_EXPORT_NAME` | Export name in Evidently Cloud  | `None`                          |
