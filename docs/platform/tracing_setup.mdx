...
| Parameter | Environment variable name   | Description                                                        | Type  | Default                         |
| --------- | --------------------------- | ------------------------------------------------------------------ | ----- | ------------------------------- |
| `address` | `EVIDENTLY_TRACE_COLLECTOR` | The URL of the collector service where tracing data will be sent.  | `str` | `https://app.evidently.cloud/`. |
