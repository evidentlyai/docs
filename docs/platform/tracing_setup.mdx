...
| `track_args: Optional[List[str]]`  | A list of function arguments to include in the event.                                                                                          | `None` (all arguments)       |
...
| `track_args: Optional[List[str]]`  | A list of function arguments to include in the event. Defaults to `None`: all arguments are included.                                          |
| `ignore_args: Optional[List[str]]` | A list of function  arguments to exclude, e.g. arguments that contain sensitive data. Defaults to `None`: no arguments are ignored.            |
...
If you need to create a trace event without using a decorator (e.g., for a specific piece of code), you can use the context manager:
...
| Parameter        | Description                                                                                                                   | Default |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------- |
| `name`           | The name of the event used as its label.                                                                                      | -       |
