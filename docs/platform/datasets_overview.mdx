...
To view Datasets, go to the **Dataset Page** within your Project. There, you'll find:

* Source datasets you uploaded.

* Synthetic data you generated.

* New datasets with added scores from evaluations (local or cloud).

<Tip>
  **Looking for tracing data?** It is in the Tracing menu section.
</Tip>
