...
* When adding a Panel, you point to the **source Metric or Test** and the value (`metric_result`) inside it. Evidently will pull selected value(s) from all Reports in the Projects and plot them on the Panel. You can also navigate between Panels and source Reports / datasets by clicking on the specific value on the Panel.
...
<CardGroup cols="2">
  <Card title="Stacked" img="/images/dashboard/panel_dist_stacked_2-min.png">
    Stacked bar chart `HistBarMode.STACK`. Shows **absolute** counts in single bar.
  </Card>

  <Card title="Grouped" img="/images/dashboard/panel_dist_group_2-min.png">
    Grouped bar chart `HistBarMode.GROUP`. Shows **absolute** counts in separate bars.
  </Card>

  <Card title="Overlay" img="/images/dashboard/panel_dist_overlay-min.png">
    Overlay bar chart `HistBarMode.OVERLAY`. Shows overlaying **absolute** counts.
  </Card>

  <Card title="Relative" img="/images/dashboard/panel_dist_relative-min.png">
    Relative bar chart `HistBarMode.RELATIVE`. Shows stacked **relative** frequency.
  </Card>
</CardGroup>
