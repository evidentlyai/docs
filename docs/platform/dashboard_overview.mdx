...
Each Project has a Dashboard. It's empty at first. To populate it, you need to run an evaluation and save at least one Report to the Project. You can then plot values from individual Reports over time.
