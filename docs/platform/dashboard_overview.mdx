...
* **Tags** (optional). You can them to filter and visualize specific data subsets on Panels. You must first add these Tags (e.g. a model version) to Reports when you run an evaluation.
