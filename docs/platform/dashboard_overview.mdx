...
When you create a new Project, it's Dashboard is empty. To populate it, run evaluations and save at least one Report to the Project. You can then plot values from individual Reports over time.

## When to use Dashboard?

You can use Dashboard to monitor live production quality evaluations or to track results from offline experiments.
