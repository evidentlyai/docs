...
<Tip>
  **From Dashboard to Data**. By clicking on any individual value on the Dashboard, you can open the associated Report and source Dataset for further debugging.
</Tip>
