...
<Steps>
  ...
  <Step title="Configure the dashboard">
    ...
    As you send multiple Reports to the platform, you can also use a Dashboard to track results over time. Set it up using pre-built Tabs or configure your own choice of monitoring Panels.
