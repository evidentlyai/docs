...
Evidently Platform lets you run various quality workflows across the AI product lifecycle. It supports both LLM-based apps and classic machine learning tasks (often part of larger AI solutions).
...
<Info>
  Evidently Platform has a lightweight open-source version for evaluation tracking and monitoring, and a Cloud/Enterprise version with added features like data storage, no-code tools, collaboration, and synthetic data. [Understand feature availability.](/faq/oss_vs_cloud)
</Info>
...
<Tabs>
  ...
  <Tab title="Synthetic data">
    Generate synthetic data for RAG, Q&A or any other use case and collaboratively review it on the platform to speed up and augment the process of designing test cases for your LLM app. Generate adversarial data for safety and stress-testing. 

    ADD IMG
  </Tab>

  <Tab title="Evaluations">
    Run evaluations locally using the Evidently Python library or no-code directly on the platform. Use 100+ built-in evals and templates. Track experiments and easily debug results.
