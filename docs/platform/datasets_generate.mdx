...
<Check>
  Synthetic data generation is a Pro feature on Evidently Cloud / Enterprise's paid plans. Limits apply to the free plan. Check details on the [pricing](https://www.evidentlyai.com/pricing) page. [Request a demo](https://www.evidentlyai.com/get-demo) or contact sales@evidentlyai.com for trial access.
</Check>
...
* Synthetic generation: Describe the task (like "healthcare chatbot") and generate example inputs the users can ask. Once you create an initial dataset, you can further add more examples by selecting the ones you like and using the "More like this" option.
...
Check the video with the basic flow:
