...
<Info>
**Evidently Enterprise.** This page explains how to self-host the open-source platform. [Contact us](https://www.evidentlyai.com/get-demo) for self-hostable Enterprise version with extra features and support. Compare [OSS vs. Enterprise/Cloud](/faq/oss_vs_cloud).
</Info>
