...
<Info>
  **Evidently Enterprise.** This page explains how to self-host the open-source platform. [Reach out](https://www.evidentlyai.com/get-demo) to get access to the self-hostable Enterprise version with extra features and support. Understand [OSS vs Enterprise features](/faq/oss_vs_cloud).
</Info>
