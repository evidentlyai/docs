...
<Note>
  You need a token for programmatic tasks like tracing or logging local evals. Many other tasks can be done directly on the platform.
</Note>
...
First [install the Evidently Python library](/docs/setup/installation).
