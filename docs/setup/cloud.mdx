...
<Note>
  **Do I always need this?** No, you can view and upload data, edit dashboard and run no-code evaluations directly on the platform. You only need the token to interact with platform programmatically, like to set up tracing or run local evals.
</Note>
