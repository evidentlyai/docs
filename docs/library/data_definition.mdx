...
(e.g., text columns treated as categorical may show a distribution histogram).

<Note>
If you have **text data**, you can [generate descriptors](/docs/library/descriptors) without explicit mapping. However, it's best to map the inputs since you may later run other types of analysis over the complete dataset with text and metadata like a Data Summary report.
</Note>
