...
| ----------- | ------------------------------------------------------ | ------------------------- |
| `id_column` | <ul><li>Identifier column.</li><li>Ignored in data drift calculations.</ul></li> | Column named "id" (TBC) |
| `timestamp` | <ul><li>Timestamp column.</li><li> Ignored in data drift calculations (like any DateTime). | Column named "timestamp" (TBC)  |
