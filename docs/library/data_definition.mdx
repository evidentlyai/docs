...
Mapping column types ensures accurate processing for:
...
* Automated tests & metrics. Preset logic is mapped to column types.
...
**Options**. Available types and how automated mapping works.
