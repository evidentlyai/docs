...
Mapping **column types** helps correctly process inputs for:
* any statistical analysis (computed descriptive stats vary by column type)
* choice of visualuzation (for example, unmapped text columns are treated as categorical, which can result in irrelevant plots like raw text distribution histograms)
* data drift analysis (default drift detection methods vary by column type)
* automatically generated tests and metrics in presets 
...
| `categorical_columns` | <ul><li>Columns with categorical values.</li></ul>                                                                                                                                                                                                                                                                                                                                                                 | All other columns not classified as numerical or datetime. |
| `text_columns`        | <ul><li>Text columns.</li><li>You can generate descriptors without explicit mapping, but it's useful for further analysis. </li><li>Mapping required for text data drift detection.</li></ul> | Not automated.                    |
