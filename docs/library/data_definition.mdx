...
Knowing the column type helps Evidently compute correct statistics, visualizations, and pick default tests. You only need to map the columns you plan to use in your evaluations.
...
| `timestamp`     | <ul><li>Timestamp column.</li><li> Ignored in data drift calculations. </li></ul> | Column named "timestamp" (TBC) |
