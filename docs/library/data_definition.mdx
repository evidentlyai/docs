...
Only map what you need for your evals. For example, you don’t need roles like target/prediction to run data quality checks.
...
Mapping **column types** helps process inputs for data quality and data drift analysis. This helps generate correct statistics, visualizations and types of tests.

<li>Mapping affects choice of stats, automated tests, data drift methods and visualizations.</li>
