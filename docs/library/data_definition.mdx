...
Knowing the column type helps Evidently compute correct statistics, visualizations, and pick default tests. You only need to map the ones you plan to use in your evaluations. 
