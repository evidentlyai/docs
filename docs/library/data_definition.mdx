...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| `numerical_columns`   | <ul><li>Columns with numeric values.</li><li>Affects stats, visualizations, automated test choice, and data drift detection methods.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                            | All columns with numeric types (`np.number`).              |
...
| `categorical_columns` | <ul><li>Columns with categorical values.</li><li>Affects stats, visualizations, automated test choice, and data drift detection methods.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                        | All other columns not classified as numerical or datetime. |
| `text_columns`        | <ul><li>Text columns.</li><li>You can generate descriptors without explicitly mapping text columns; however, doing so is useful for statistical analysis (e.g., generating a Data Summary Report) to get appropriate visualizations and exclude text data from some automated tests where they don’t apply.</li><li>Unmapped text columns are treated as categorical, which may result in irrelevant evaluations like raw text distribution histograms.</li><li>You always need to map text data for text data drift detection.</li></ul> | Not automated; manual mapping required.                    |
