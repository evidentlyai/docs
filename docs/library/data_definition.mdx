...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| `numerical_columns`   | <ul><li>Columns with numeric values.</li><li>Mapping affects choice of stats, automated tests, data drift methods and visualizations.</li></ul>                                                                                                                                                                                                                                                                                                                                                                      | All columns with numeric types (`np.number`).              |
...
| `categorical_columns` | <ul><li>Columns with categorical values.</li><li>Mapping affects choice of stats, automated tests, data drift methods and visualizations. </li></ul>                                                                                                                                                                                                                                                                                                                                                                 | All other columns not classified as numerical or datetime. |
| `text_columns`        | <ul><li>Text columns.</li><li>You can generate descriptors without explicit mapping, but it's useful for further analysis. </li><li> Affects choice of automated tests (many don't apply for texts), statics and visuals. </li><li>Unmapped text columns are treated as categorical, which can result in irrelevant plots like raw text distribution histograms.</li><li>Mapping required for text data drift detection.</li></ul> | Not automated.                    |
| `embeddings` (TBC)    | <ul><li>Columns containing embeddings.</li><li> pass a dictionary where keys are embedding names and values are lists of columns.</li><li>Required for embeddings data drift detection.</li></ul>                                                                                                                                                                                                                                                                                            | Not automated; manual mapping required.                    |
