...
This page shows the core evaluation workflow with the open-source Evidently library. You can adapt it for many scenarios: from experiments and production monitoring, and across use cases: from data to LLM. 
