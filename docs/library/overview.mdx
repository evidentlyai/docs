...
<Tabs>
  <Tab title="LLM logs">
**LLM logs** Pass any text columns with LLM inputs and outputs. Add optional context or ground truth.
...
**Data table** Pass any data table to get a data overview, run data quality and distribution drift checks.
