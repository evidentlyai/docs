...
## Workflow
* **Pass input data**. Use text, tabular, or embeddings data. Optionally define a schema.
* **Define evaluations**. Choose from 100+ metrics or add custom ones. Optionally set pass/fail conditions.
* **Get results** in any of the formats: 
  * View as a visual Report or Test Suite in an interactive Python environment (Jupyter, Colab).
  * Export as JSON, Python dict, pandas, or HTML file.
