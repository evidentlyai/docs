...
Evidently has a modular architecture. You can use the evaluationlibrary on its own, or together with the Monitoring Platform (self-hosted or Evidently Cloud).
