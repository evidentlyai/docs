...
You can use built-in descriptors, configure templates or add fully custom checks in Python. Each Descriptor returns a result that can be:
...
Metrics also range from simple statistics to complex algorithmic evals.
