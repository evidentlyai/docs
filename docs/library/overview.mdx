...
<Tabs>
  ...
  <Tab title="Ranking">
    **Ranking logs**. To evaluate ranking or recommendations, pass a table that contains columns with rank/score and interaction results. User/query and item features are optional but useful for some evals.
