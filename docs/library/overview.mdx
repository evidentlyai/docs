...
<Steps>
  <Step title="Pass input data">
    Use text, tabular, or embeddings data. Optionally [define a schema](/data_overview).
  </Step>

  <Step title="Configure evaluations">
    Evidently supports [3 evaluation modes](/evaluations_overview) with a declarative API.
