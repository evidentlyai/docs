...
* **Define evaluations**. Choose from 100+ metrics. Optionally set pass/fail conditions.

* **Get results** in any of the formats:

  * A visual Report or Test Suite in an interactive Python environment (Jupyter, Colab).

  * Export as JSON, Python dict, pandas DataFrame, or HTML file.
