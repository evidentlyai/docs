...
<Steps>
  ...
  <Step title="Run evaluations">
    ...
    |                                                                                          |                                                                                    |
    | :--------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
    |                                  **🔡 Text descriptors**                                 |                              **📝 LLM output quality**                             |
    | Length, sentiment, toxicity, language, special symbols, regular expression matches, etc. |   Semantic similarity, relevance, helpfulness, templates for custom LLM judges.    |
    ...
    |                                **🗂 Ranking (incl. RAG)**                                |                               **🛒 Recommendations**                               |
