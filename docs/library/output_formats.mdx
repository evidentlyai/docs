...
* You generate a Report using `run`

You can view or export results from Evidently Reports in multiple formats.

### Log to Workspace

You can save the evaluation result in Evidently Cloud or your local workspace.
