...
<Note>
**Get the full dataset**. You can also get a full original dataset with new row-level scores, like output-level text evaluations you compute. Check the guide on [descriptors](/docs/library/descriptors) for details.
</Note>
