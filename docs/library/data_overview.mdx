...
| Property ID | Location           | Size (sq ft) | Property Type | Bedrooms | Bathrooms | Has Garden | Predicted Price ($) | Actual Price ($) |
| ----------- | ------------------ | ------------ | ------------- | -------- | --------- | ---------- | ------------------- | ---------------- |
| PROP001     | New York, USA      | 850          | Apartment     | 2        | 1         | No         | 850,000             | 870,000          |
| PROP002     | San Francisco, USA | 1200         | House         | 3        | 2         | Yes        | 1,250,000           | 1,300,000        |
| PROP003     | London, UK         | 950          | Flat          | 2        | 2         | No         | 700,000             | 720,000          |

  </Tab>

  <Tab title="Ranking">
    To evaluate ranking or recommendations, pass a table that contains columns with predicted rank/score and interaction result. User/query and item features are optional but useful for some evals.
