...
<Tabs>
  <Tab title="LLM logs">
    To evaluate generative AI quality, pass LLM outputs with optional context and ground truth. You can include any number of text and metadata columns.
  ...
  <Tab title="Data table">
    Pass any data table to get a data overview, run data quality and distribution drift checks. This could also be production logs of your ML model with input features and prediction columns.
