...
- ⚡️ **Improved performance** – lighter and more efficient calculations.
- 🤖 **Full LLM evaluation support** – new features focused on LLM evaluations, like the ability to run descriptor calculation in the cloud.
...
<Warning>
**Breaking changes:** Cloud v2 is **not backward compatible** with Evidently library versions below `0.7.0`.
</Warning>
