...
Why evals are core, Evidently Platform offers a comprehensive feature set to support AI quality workflows: with tracing, synthetic data, rich dashboard, built-in alerting etc.
...
Evidently Platform can support both complex nested workflows and structured tabular data, and has relevant metrics and views for both. This means you won't be locked into a single approach - or have to reinvent the wheel to measure things like Hit Rate or Precision over traces.
