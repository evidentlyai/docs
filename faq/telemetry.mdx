...
<AccordionGroup>
  <Accordion title="Action: startup" defaultOpen="true">
    Action: startup.
  ...
  <Accordion title="Action: index" defaultOpen="false">
    ```
     {
...
<Accordion title="Action: startup" defaultOpen="false">
  ```
  {
    "_timestamp": "2023-07-07T14:08:44.332528Z",
    "action": "startup",
...
<Accordion title="Action: list_projects" defaultOpen="false">
  ```
  {
...
<Accordion title="Action: get_project_info" defaultOpen="false">
  ```
  {
...
<Accordion title="Action: project_dashboard" defaultOpen="false">
  ```
  {
...
<Accordion title="Action: add_project" defaultOpen="false">
  ```
  {
...
<Accordion title="Action: list_reports" defaultOpen="false">
  ```
  {
...
<Accordion title="Action: list_test_suite" defaultOpen="false">
  ```
  {
...
<Accordion title="Action: Action: get_snapshot_data" defaultOpen="false">
  ```
  {
