...
## <img alt="Hero Dark" classname="hidden dark:block" src="/images/hero-dark.svg" />What is Evidently?
...
Evidently is available both as an open-source Python library and Evidently Cloud platform.![](main_img)
