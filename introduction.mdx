...
<CardGroup cols={4}>
  <Card title="Evidently Python library" icon="book" href="/overview">
    Understand key components of the evaluation library.
  </Card>

  <Card title="Evidently Platform" icon="book" href="/overview">
    Understand key features of the observability platform.
  </Card>
