...
<Info>
Evidently API has changed. Read more about [new Evidently library version](https://docs.evidentlyai.com/faq/migration) and [Evidently Cloud v2]((https://docs.evidentlyai.com/faq/cloud_v2).
</Info>
