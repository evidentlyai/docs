...
<CardGroup cols={2}>
  <Card title="Evidently Platform" icon="desktop" href="/docs/platform/overview" img="/images/platform_small-min.png">
    Key features of the AI observability platform.
  </Card>

  <Card title="Evidently library" icon="file-chart-column" href="docs/library/overview">
