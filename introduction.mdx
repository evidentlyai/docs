...
<Info>
  **Evidently API has changed**. Read more about [API updates](https://docs.evidentlyai.com/faq/migration) and new [Evidently Cloud](https://docs.evidentlyai.com/faq/cloud_v2).
</Info>

<Note>
  **Applied course on LLM evaluations starts May 12**\! Free video course with 10\+ tutorials. [Sign up](https://www.evidentlyai.com/llm-evaluation-course-practice).
</Note>
