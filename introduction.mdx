...
<CardGroup cols={2}>
  <Card title="LLM quickstart" icon="fa-duotone fa-solid fa-comment-text" href="/quickstart_llm">
    Evaluate the quality of text outputs.
  </Card>

  <Card title="ML quickstart" icon="fa-solid fa-table" href="/quickstart_ml">
