...
- Explore options for Dashboard design: [Dashboards](/platform/dashboard_add_panels)

<Info>
Alternatively, you can try `DataSummaryPreset` that will generate a summary of all columns in the dataset, and run auto-generated Tests to check for data quality and core descriptive statistics between two datasets.
